...
# # # Save the label encoder state as a JSON file
# with open("label_encoder_state.json", "w") as le_file:
#     json.dump(label_encoder.classes_.tolist(), le_file)

# # Save the model's architecture and weights in an HDF5 file
...
preprocessor = ColumnTransformer(
    ...
    remainder='drop'  # Exclude non-categorical columns
)
...
# Save the model using joblib (an alternative to pickle)
import joblib
